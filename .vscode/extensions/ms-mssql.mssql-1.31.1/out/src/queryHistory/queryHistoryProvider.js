    ...
    showQueryHistoryCommandPalette() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (queryHistoryQuickPickItem) {
                yield this.openQueryHistoryEntry(queryHistoryQuickPickItem.node, queryHistoryQuickPickItem.action === queryHistoryUI_1.QueryHistoryAction.RunQueryHistoryAction);
            }
            return undefined;
        });
    }
