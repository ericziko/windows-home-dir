...
(function ($) {
    ...
    function dragRowSelectionModel() {
        ...
        function isColumnResize(e) {
            return ((e.which === $.ui.keyCode.LEFT || e.which === $.ui.keyCode.RIGHT || e.shiftKey) &&
                (e.ctrlKey || e.metaKey));
        }
        function navigateLeft(e, activeCell) {
            if (activeCell.cell > 1) {
                ...
                if (e.shiftKey) {
                    ...
                    _ranges = [
                        new Slick.Range(activeCell.row, newRangeColumn, activeCell.row, newRangeColumn),
                    ];
                }
                ...
                if (isNavigationKey(e)) {
                    ...
                    if (e.which === $.ui.keyCode.LEFT) {
                        ...
                        if (e.shiftKey) {
                            ...
                            _ranges = [
                                new Slick.Range(activeCell.row - 1, activeCell.cell, activeCell.row - 1, activeCell.cell),
                            ];
                        }
