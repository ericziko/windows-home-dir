...
exports.AppModule = AppModule = __decorate([
    (0, core_1.NgModule)({
        ...
        declarations: [
            ...
            angular2_slickgrid_1.SlickGrid,
            scroll_directive_1.ScrollDirective,
            mousedown_directive_1.MouseDownDirective,
            contextmenu_component_1.ContextMenu,
            messagescontextmenu_component_1.MessagesContextMenu,
        ],
