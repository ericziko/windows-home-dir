        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isTaskCompleted(taskProgressInfo.status)) {
                ...
                const lastMessage = (_a = (taskProgressInfo.message &&
                    taskProgressInfo.message.toLowerCase() !== taskStatusString.toLowerCase())) !== null && _a !== void 0 ? _a : taskInfo.lastMessage;
                ...
                if (taskInfo.taskInfo.taskExecutionMode === 1 /* TaskExecutionMode.script */ &&
