...
class QueryRunner {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tasks = selection.map((range) => {
                return () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    this.getRowMappings(result.resultSubset.rows, range, rowIdToSelectionMap, rowIdToRowMap);
                });
            });
            // get all the rows
            let p = tasks[0]();
            ...
            yield this.writeStringToClipboard(copyString);
        });
    }
    exportCellsToClipboard(data, batchId, resultId, selection, headersFlag) {
        return __awaiter(this, void 0, void 0, function* () {
            let copyString = "";
            if (headersFlag) {
                copyString = this.addHeadersToCopyString(copyString, batchId, resultId, selection);
     ...
     * @param rowIdToRowMap
     */
    getRowMappings(data, range, rowIdToSelectionMap, rowIdToRowMap) {
        let count = 0;
        for (let row of data) {
    ...
    constructCopyString(copyString, rowIdToRowMap, rowIdToSelectionMap) {
     ...
     * @returns
     */
    addHeadersToCopyString(copyString, batchId, resultId, selection) {
    ...
    writeStringToClipboard(copyString) {
        return __awaiter(this, void 0, void 0, function* () {
            let oldLang;
            if (process.platform === "darwin") {
                oldLang = process.env["LANG"];
