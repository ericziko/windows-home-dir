...
class LocConstants {
    ...
    get common() {
        return {
            ...
            searchResultSummary: (activeElement, totalElements) => l10n.t({
                message: "{0} of {1}",
    ...
    get firewallRules() {
        return {
            createNewFirewallRuleFor: (serverName) => l10n.t({
            ...
            signIntoAzureToAddFirewallRule: l10n.t("Sign into Azure in order to add a firewall rule."),
            signIntoAzure: l10n.t("Sign into Azure"),
            tenant: l10n.t("Tenant"),
            ruleName: l10n.t("Rule name"),
            addMyClientIp: (ipAddress) => l10n.t({
    ...
    get schemaDesigner() {
        return {
            ...
            incompatibleLength: (sourceColumn, targetColumn, sourceLength, targetLength) => l10n.t({
            ...
            incompatiblePrecisionOrScale: (sourceColumn, targetColumn) => l10n.t({
            ...
            incompatibleScale: (sourceColumn, targetColumn) => l10n.t({
                message: "Scale mismatch between '{0}' and '{1}'",
                args: [sourceColumn, targetColumn],
                comment: ["{0} is source column", "{1} is target column"],
            }),
            referencedColumnNotPK: (targetColumn) => l10n.t({
                message: "Column '{0}' must be a primary key",
                args: [targetColumn],
                comment: ["{0} is the referenced column"],
            }),
            cyclicForeignKeyDetected: (tableName, targetTable) => l10n.t({
            ...
            columnMaxLengthInvalid: (maxLength) => l10n.t({
            ...
            nWarnings: (warningCount) => l10n.t({
                message: "{0} warnings",
                args: [warningCount],
                comment: ["{0} is the number of warnings"],
            }),
            nErrors: (errorCount) => l10n.t({
                message: "{0} errors",
                args: [errorCount],
    ...
    get schemaCompare() {
        return {
            intro: l10n.t("To compare two schemas, first select a source schema and target schema, then press compare."),
            ...
            stop: l10n.t("Stop"),
            generateScript: l10n.t("Generate Script"),
            generateScriptToDeployChangesToTarget: l10n.t("Generate script to deploy changes to target"),
            apply: l10n.t("Apply"),
            ...
            loadSourceTargetAndOptionsSavedInAnScmpFile: l10n.t("Load source, target, and options saved in an .scmp file"),
            saveScmpFile: l10n.t("Save .scmp file"),
            saveSourceAndTargetOptionsAndExcludedElements: l10n.t("Save source and target, options, and excluded elements"),
            type: l10n.t("Type"),
            ...
            areYouSureYouWantToUpdateTheTarget: l10n.t("Are you sure you want to update the target?"),
            thereWasAnErrorUpdatingTheProject: l10n.t("There was an error updating the project"),
            schemaCompareApplyFailed: (errorMessage) => l10n.t({
            ...
            cannotIncludeEntryWithBlockingDependency: (diffEntryName, firstDependentName) => l10n.t({
            ...
            cannotExcludeEntry: (diffEntryName) => l10n.t({
                message: "Cannot exclude {0}. Included dependents exist",
                args: [diffEntryName],
                comment: ["{0} is the name of the entry"],
            }),
            cannotIncludeEntry: (diffEntryName) => l10n.t({
                message: "Cannot include {0}. Excluded dependents exist",
                args: [diffEntryName],
                comment: ["{0} is the name of the entry"],
            }),
            includeExcludeAllOperationInProgress: l10n.t("Processing include or exclude all differences operation."),
        };
    }
}
