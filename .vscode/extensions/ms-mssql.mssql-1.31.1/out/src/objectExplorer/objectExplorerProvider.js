...
class ObjectExplorerProvider {
    constructor(_vscodeWrapper, connectionManager) {
        ...
        this._objectExplorerService = new objectExplorerService_1.ObjectExplorerService(this._vscodeWrapper, connectionManager, this);
    }
    getParent(element) {
